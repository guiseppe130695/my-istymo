...
class SCI_INPI_Token_Manager {
    ...
    public function refresh_token() {
        ...
        // ✅ NOUVEAU : Synchroniser le token dans la configuration principale
        $this->sync_token_to_config($body['token']);
    ...
    /**
     * ✅ NOUVELLE MÉTHODE : Synchronise le token dans la configuration principale
     */
    private function sync_token_to_config($token) {
        // Récupérer la configuration actuelle
        $config_option_name = 'sci_api_config';
        $current_config = get_option($config_option_name, array());
        
        // Mettre à jour le token INPI
        $current_config['inpi_token'] = $token;
