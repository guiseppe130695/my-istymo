/**
 * JavaScript pour le système Lead Parrainage
...
(function($) {
    ...
    /**
     * Initialisation du système Lead Parrainage
     */
    function initLeadParrainage() {
        console.log('Initialisation Lead Parrainage...');
        
        if (typeof leadParrainageAjax === 'undefined') {
            console.warn('Lead Parrainage: Variables AJAX non disponibles');
            return;
        }

        console.log('Variables AJAX trouvées:', leadParrainageAjax);
    ...
    function attachEventListeners() {
        ...
        $(document).on("click", ".favorite-btn", function(e) {
            ...
            var $row = $toggle.closest(".lead-parrainage-row");
            ...
            $.ajax({
                ...
                data: {
                    ...
                    entry_id: entryId,
                    form_id: leadParrainageAjax.form_id,
    ...
    function loadPage(page) {
        ...
        var $tableBody = $("#lead-parrainage-table-body");
        var $paginationContainer = $("#lead-parrainage-pagination-container");
        var $paginationInfo = $("#lead-parrainage-pagination-info");
        ...
        // Requête AJAX
        $.ajax({
            url: leadParrainageAjax.ajax_url,
            type: "POST",
            data: {
                action: "lead_parrainage_pagination",
                nonce: leadParrainageAjax.nonce,
                page: page,
                per_page: leadParrainageAjax.per_page
            },
            success: function(response) {
                if (response.success) {
                    ...
                    $(".lead-parrainage-row").each(function(index) {
    ...
    function showLeadDetails(entryId) {
        ...
        console.log('Variables AJAX disponibles:', leadParrainageAjax);
        ...
        $.ajax({
            ...
            type: "POST",
            data: {
                action: "lead_parrainage_get_entry_details",
                entry_id: entryId,
                nonce: leadParrainageAjax.nonce
            },
            success: function(response) {
    ...
    function showMessage(message, type) {
        ...
        $('.lead-parrainage-table-container').before($message);
        setTimeout(function() {
            $message.fadeOut();
        }, 3000);
    }
    ...
    window.leadParrainage = {
        init: initLeadParrainage,
        loadPage: loadPage,
    ...
    window.openLeadDetailModal = function(leadId) {
        ...
        console.log('Variables AJAX disponibles:', typeof leadParrainageAjax !== 'undefined' ? leadParrainageAjax : 'NON DÉFINI');
    ...
    $(document).ready(function() {
        console.log('Document ready - Initialisation Lead Parrainage');
        console.log('Script lead-parrainage.js chargé');
        initLeadParrainage();
    });
    
    // Debug global
    console.log('Script lead-parrainage.js initialisé');
