<?php
/**
 * Page de configuration pour les leads parrainage
 */

if (!defined('ABSPATH')) exit;

function lead_parrainage_config_page() {
    $config_manager = lead_parrainage_config_manager();
    $config = $config_manager->get_config();
    
    // Traitement du formulaire de configuration
    if (isset($_POST['submit']) && wp_verify_nonce($_POST['lead_parrainage_config_nonce'], 'lead_parrainage_config')) {
        $new_config = array(
    ...
    <div class="wrap">
        <h1>⚙️ Configuration Lead Parrainage</h1>
        ...
        <div class="my-istymo-container">
            <div class="my-istymo-card">
                ...
                <form method="post" action="">
                    <?php wp_nonce_field('lead_parrainage_config', 'lead_parrainage_config_nonce'); ?>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description">Sélectionnez le formulaire Gravity Forms à utiliser pour les leads parrainage.</p>
                            </td>
                        </tr>
    ...
    function loadFormFields() {
        ...
        if (formId > 0) {
            location.href = '<?php echo admin_url('admin.php?page=lead-parrainage-config'); ?>&form_id=' + formId;
        }
    }
    </script>
    <?php
